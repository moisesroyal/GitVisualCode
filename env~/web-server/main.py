...
def run():
  ...
  '''
  data = read_csv.read_csv('/root/platzi/env~/web-server/data.csv')
  ...
  # df(dataframe) 
  df = pd.read_csv("/root/platzi/env~/web-server/data.csv")  # Nos ahorramos el método creado read_csv.py
